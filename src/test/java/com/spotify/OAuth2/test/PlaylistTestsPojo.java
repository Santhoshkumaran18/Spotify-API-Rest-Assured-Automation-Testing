...
public class PlaylistTestsPojo {
	...
	public void shouldbeAbleTocreatePlaylist() {
		...
		requestPlaylist.setDescription("New playlist Descritption");
	...
	public void shouldBeAbletoupdatethePlaylist() {
		Playlist requestPlaylist = new Playlist();
		requestPlaylist.setName("AR Rahman and Anirudh playlist updated");
		requestPlaylist.setDescription("New playlist Descritption");
		requestPlaylist.setPublic(false);

		given().spec(requestspecification).body(requestPlaylist).when()
				.put("/playlists/4s6DQK4WEWrKeQWL0aV6Sq").then().assertThat()
				.statusCode(200);
